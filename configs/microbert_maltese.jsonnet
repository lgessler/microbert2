...
local experiment_name = "maltese_mlm_mt_500K";
local rclone_remote_path = "iu:iu/runs/20251208_"+experiment_name;
// Tokenization -------------------------------------------------------------------
        ...
        trained_model: {
            ...
            callbacks: [
                ...
                {type: "microbert2.microbert.model.model::reset_metrics"},
                {
                    ...
                    upload_logs: true,
                    slurm_output_dir: "/N/u/partkaew/BigRed200/sl",
                    slurm_job_name: "cpt-mx-md"
                },
            ],
        },
        //final_metrics: {
